  ...
  <div class="flex flex-wrap max-w-[1700px] justify-between mx-auto">
    ...
    <div class="mx-auto">
      ...
      >
        ...
        <p class="mb-12 text-left">
          • Verbesserte Jobmöglichkeiten <br />
          • Kommunikationsfähigkeit <br />
          • Verbesserte Reiseerlebnisse <br /> • Globales Networking <br />
  ...
  <div class="flex flex-wrap max-w-[1700px] justify-between mx-auto">
    <div class="mx-auto">
      ...
      >
        ...
        <p class="mb-12 text-left">
          • Gespräche auf Schwedisch führen <br />
          • Selbstbewusst nach Schweden Reisen <br />
          • Arbeiten/Studieren in Schweden <br />
          • Verständnis der Schwedischen Kultur
        </p>
        <span class="mb-12 font-bold text-3xl"
          >25€ <br />
          <span class="text-sm font-medium text-gray-400">pro Stunde</span
    ...
    <div class="mx-auto">
      ...
      >
        ...
        <p class="mb-12 text-left">
          ...
          • Javascript <br />
          • Sichere zunkunft <br />
          • Lebenslauf <br /> (Extra für die IT-Branche)<br />
